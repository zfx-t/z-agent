...
import type { JsonlOpStore } from "./store.ts";

export function wrapTools(tools: AgentTool[], store: JsonlOpStore): AgentTool[] {
...
export function wrapStreamFn(streamFn: StreamFn, store: JsonlOpStore): StreamFn {
